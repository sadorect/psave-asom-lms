          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex flex-column align-items-center text-center">
                <img src="{{ (!empty($profileData->photo)) ? url('upload/instructor_images/'.$profileData->photo) : url('upload/no_image.jpg')}}" alt="instructor" class="rounded-circle p-1 bg-primary" width="100" height="100">
                <div class="mt-3">
        ...
        <div class="col-lg-8">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row mb-3">
                <div class="col-sm-3">
                  <h6 class="mb-0">Photo on file</h6>
                </div>
                <div class="col-sm-9 text-secondary">
                  <img id="showImage" src="{{ (!empty($profileData->photo)) ? url('upload/instructor_images/'.$profileData->photo) : url('upload/no_image.jpg')}}" alt="instructor" class="rounded-circle p-1 bg-primary showImage" width="80" height="80">
                </div>
              </div>
              <div class="row">
