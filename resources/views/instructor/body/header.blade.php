    ...
    <nav class="navbar navbar-expand gap-3">
      ...
      <div class="user-box dropdown px-3">
        <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          <img id="showImage" src="{{ (!empty($profileData->photo)) ? url('upload/'.$profileRole.'_images/'.$profileData->photo) : url('upload/no_image.jpg')}}" alt="Admin" class="rounded-circle p-1 bg-primary showImage" width="40" height="40">
          <div class="user-info">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
          <li><a class="dropdown-item d-flex align-items-center" href="{{ route($profileRole.'.profile')}}"><i class="bx bx-user fs-5"></i><span>Profile</span></a>
          </li>
          <li><a class="dropdown-item d-flex align-items-center" href="{{ route($profileRole.'.change.password')}}"><i class="bx bx-cog fs-5"></i><span>Change Password</span></a>
          </li>
          ...
          <li><a class="dropdown-item d-flex align-items-center" href="{{route($profileRole.'.logout')}}"><i class="bx bx-log-out-circle"></i><span>Logout</span></a>
          </li>
        </ul>
      </div>
    </nav>
