                      ...
                      <form method="post" class="row" action="{{ route('instructor.register')}}">
                        @csrf
                          ...
                          <div class="input-box col-lg-6">
                              ...
                              <div class="form-group">
                                  <input class="form-control form--control @error('name') is-invalid @enderror" type="email" name="email" placeholder="e.g. alexsmith@gmail.com">
                          ...
                          <div class="input-box col-lg-4">
                              ...
                              <div class="form-group">
                                  <input id="phone" class="form-control form--control @error('phone') is-invalid @enderror" type="text" name="text">
                              </div>
                              @error('phone')
                                  <span class="text-danger">{{ $message }}</span>
                              @enderror
                          ...
                          <div class="input-box col-lg-8">
                            ...
                            <div class="form-group">
                                <input class="form-control form--control @error('name') is-invalid @enderror" type="text" name="address" placeholder="e.g. 12345 Little Baker St, Melbourne">
