      ...
      <div class="row">
          <div class="col-lg-4 responsive-column-half">
              <div class="card card-item hover-s text-center">
                  <div class="card-body">
                      <img src="{{ asset('frontend/asset/images/img-loading.png') }}" data-src="{{ asset('frontend/asset/images/small-img-2.jpg') }}" alt="card image" class="img-fluid rounded-full lazy">
          ...
          <div class="col-lg-4 responsive-column-half">
              <div class="card card-item hover-s text-center">
                  <div class="card-body">
                      <img src="{{ asset('frontend/asset/images/img-loading.png') }}" data-src="{{ asset('frontend/asset/images/small-img-3.jpg') }}" alt="card image" class="img-fluid rounded-full lazy">
          ...
          <div class="col-lg-4 responsive-column-half">
              <div class="card card-item hover-s text-center">
                  <div class="card-body">
                      <img src="{{ asset('frontend/asset/images/img-loading.png') }}" data-src="{{ asset('frontend/asset/images/small-img-4.jpg') }}" alt="card image" class="img-fluid rounded-full lazy">
