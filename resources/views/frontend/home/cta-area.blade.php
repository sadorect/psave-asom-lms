  ...
  <div class="container">
      <div class="cta-content-wrap text-center">
          <div class="section-heading">
              <h5 class="ribbon ribbon-lg mb-2">Attend ASOM Bible School</h5>
              <h2 class="section__title fs-45 lh-55">Enhance Your Ministry with <br> Spirit-led Inspirational teachings</h2>
