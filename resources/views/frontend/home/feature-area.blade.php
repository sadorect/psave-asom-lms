      ...
      <div class="row feature-content-wrap">
          <div class="col-lg-4 responsive-column-half">
              <div class="info-box">
                  ...
                  <h3 class="info__title">Christian Teachers</h3>
                  <p class="info__text">Guiding Hearts with Grace, Illuminating Minds with Truth - Nurturing Faith Through Dedicated Christian Education</p>
              </div><!-- end info-box -->
          </div><!-- end col-lg-3 -->
          <div class="col-lg-4 responsive-column-half">
              <div class="info-box">
                  ...
                  <h3 class="info__title">Simple Teaching</h3>
                  <p class="info__text">Unveiling Profound Truths with Simplicity - Where Wisdom Meets Accessibility in the Journey of Spiritual Growth.</p>
              </div><!-- end info-box -->
          </div><!-- end col-lg-3 -->
          <div class="col-lg-4 responsive-column-half">
              <div class="info-box">
                  ...
                  <h3 class="info__title">Be Equipped</h3>
                  <p class="info__text">Ignite Your Spirit, Fuel Your Passion - Transformative Inspiration for a Purposeful and Fulfilling Christian Life.</p>
              </div><!-- end info-box -->
          </div><!-- end col-lg-3 -->
      </div><!-- end row -->
  </div><!-- end container -->
