  ...
  <div class="container">
      ...
      <div class="blog-post-carousel owl-action-styled half-shape mt-30px">
          <div class="card card-item">
              <div class="card-image">
                  <a href="blog-single.html" class="d-block">
                      <img class="card-img-top" src="{{ asset('frontend/asset/images/img8.jpg') }}" alt="Card image cap">
                  </a>
          ...
          <div class="card card-item">
              <div class="card-image">
                  <a href="blog-single.html" class="d-block">
                      <img class="card-img-top" src="{{ asset('frontend/asset/images/img9.jpg') }}" alt="Card image cap">
                  </a>
                  <div class="course-badge-labels">
                      <div class="course-badge">Jan 24, 2020</div>
                  </div>
          ...
          <div class="card card-item">
              <div class="card-image">
                  <a href="blog-single.html" class="d-block">
                      <img class="card-img-top" src="{{ asset('frontend/asset/images/img10.jpg') }}" alt="Card image cap">
                  </a>
                  <div class="course-badge-labels">
                      <div class="course-badge">Jan 24, 2020</div>
                  </div>
          ...
          <div class="card card-item">
              <div class="card-image">
                  <a href="blog-single.html" class="d-block">
                      <img class="card-img-top" src="{{ asset('frontend/asset/images/img11.jpg') }}" alt="Card image cap">
                  </a>
                  <div class="course-badge-labels">
                      <div class="course-badge">Jan 24, 2020</div>
                  </div>
          ...
          <div class="card card-item">
              <div class="card-image">
                  <a href="blog-single.html" class="d-block">
                      <img class="card-img-top" src="{{ asset('frontend/asset/images/img12.jpg') }}" alt="Card image cap">
                  </a>
                  <div class="course-badge-labels">
                      <div class="course-badge">Jan 24, 2020</div>
                  </div>
          ...
          <div class="card card-item">
              <div class="card-image">
                  <a href="blog-single.html" class="d-block">
                      <img class="card-img-top" src="{{ asset('frontend/asset/images/img13.jpg') }}" alt="Card image cap">
                  </a>
                  <div class="course-badge-labels">
                      <div class="course-badge">Jan 24, 2020</div>
                  </div>
