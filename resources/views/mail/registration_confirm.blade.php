...
<div class="bee-block bee-block-1 bee-paragraph">
<p><strong>Congratulations, {{$register['name']}} </strong><br/><strong>You have successfully enrolled for ASOM this season. </strong></p>

<h3>You have registered for ASOM</h3>

<h4>Please <a href="{{ url('https://projectsaveng.org/asom/login')}}" class="">login</a> to your dashboard to access your course resources and further instructions. </h4>
