...
<div class="page-content">
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form id="myForm" action="{{ route('update.devotional') }}" method="post" class="row g-3" enctype="multipart/form-data">
                @csrf
          ...
          <a href="{{ route('blog.devotional') }}" class="btn btn-secondary px-4">Cancel</a>
